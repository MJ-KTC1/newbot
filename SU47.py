...
Bots = [mid,"u901990e05c111c54d22a7d33a9198259"]
bot1 = cl.getProfile().mid
admsa = "u901990e05c111c54d22a7d33a9198259"
admin = "u901990e05c111c54d22a7d33a9198259"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u901990e05c111c54d22a7d33a9198259":
                    if "join:" in msg.text:
...
#-----------------------------------------------
                ...
                return
            elif msg.text in ["/บอท","/help","/Help","/คำสั่ง"]:
                if wait["lang"] == "JP":
