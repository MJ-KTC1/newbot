...
#-------------------------------------------------------------------------------
                        ...
                        for target in targets:
                            try:
                                ...
                                unk.sendMessage(msg.to,"Owner ☢-Bot-☢\nAdd\nExecuted")
                            except:
                                pass
...
#-------------------------------------------------------------------------------
                        ...
                        for target in targets:
                            try:
                                ...
                                unk.sendMessage(msg.to,"Admin ☯Bot☯\nAdd\nExecuted")
                                break
                            except:
...
#-------------------------------------------------------------------------------
                        ...
                        unk.sendMessage(msg.to,"Join link on")
                        unk.sendMessage(msg.to,"Qrprotect on")
                        unk.sendMessage(msg.to,"Protect on")
                        unk.sendMessage(msg.to,"Inviteprotect on")
                        unk.sendMessage(msg.to,"Cancelprotect on")
             ...
             #       if msg._from in Owner:
                        ...
                        settings["inviteprotect"] = False
                        settings["cancelprotect"] = False
                        unk.sendMessage(msg.to,"Qrprotect Off")
                        unk.sendMessage(msg.to,"Protect Off")
                        unk.sendMessage(msg.to,"Inviteprotect Off")
                        unk.sendMessage(msg.to,"Cancelprotect Off")
...
#-------------------------------------------------------------------------------
                        ...
                        unk.sendMessage(msg.to," Semua Sudah Hadir Bos Siap Beroparesi")
