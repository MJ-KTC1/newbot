...
#line = LINE()
#line = LINE("เมล","พาส")
line = LINE('EuaGYT3VFtE2LSaJUo46.tBbvHvKOjvPVuWvncrxXLG.cuutx/KeN/Mt2Jvd2N052xBqHm1o3ey7DC9/YflyhDY=')
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message1":"บริการเช่าบอท\nราคา300บาทต่อเดือน💖\n#เพิ่มคิกเกอร์ตัวละ100👌\n🎀สนใจรีบทัก..บอทpython3ฟังชั่นล้นหลาม🎁กำลังรอให้คุณเป็นเจ้าของ\n(ผมจะอยู่ที่ห้องนี้แค่15นาทีนะจ๊ะ)\nselfbot by:\n╔══════════════┓\n╠[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ] \n╚══════════════┛",
    "message":"บัญชีนี้ถูกป้องกันโดย Selfbot By [ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment":"""🎋TOME BOT LINE THAILAND🎋
    ─┅═✥👊ᵀᴴᴬᴵᴸᴬᴺᴰ👊✥═┅─ 
  💀[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]💀 
🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁
📌บริการให้เช่าเซลบอท
...
🎋(สนใจรีบโทร📲0928081567📞)
📌หรือจิ้มที่นี่👇👇👇👇👇
https://line.me/ti/p/~tomebotline
https://line.me/ti/p/~tome2527
...
「วิธีใช้ : say-th ผมชื่อต้อมนะครับ」"""
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["autoCancel"]["on"] == True:ret_+="\n╠❂➣🔵 ปฏิเสธกลุ่มเชิญที่มีน้อยกว่า: " + str(settings["autoCancel"]["members"]) + " คน"
                        else: ret_ += "\n╠❂➣❌ ปฏิเสธกลุ่มเชิญ    [ ᴏғғ ]  "						
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u4db055855928255a6f53054d0915f196")
...
#==============================================================================#
                ...
                elif "👉มีบริการให้เช่าบอท[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]\nราคา300บาทต่อเดือน💖\n#เพิ่มคิกเกอร์ตัวละ100👌\n🎀สนใจรีบทัก..บอทpython3ฟังชั่นล้นหลาม🎁กำลังรอให้คุณเป็นเจ้าของ\n(ผมจะอยู่ที่ห้องนี้แค่15นาทีนะจ๊ะ)\nselfbot by:\n╔══════════════┓\n╠[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ] \n╚══════════════┛" in msg.text:
                    spl = msg.text.split("👉มีบริการเช่าบอท[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]\nราคา300บาทต่อเดือน💖\n#เพิ่มคิกเกอร์ตัวละ100👌\n🎀สนใจรีบทัก..บอทpython3ฟังชั่นล้นหลาม🎁กำลังรอให้คุณเป็นเจ้าของ\n(ผมจะอยู่ที่ห้องนี้แค่15นาทีนะจ๊ะ)\nselfbot by:\n╔══════════════┓\n╠[ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ] \n╚══════════════┛")
                    if spl[len(spl)-1] == "":
                    ...
                    line.sendText(msg.to,"welcome to roon [ ™✭₮Ӫℳ€βӪ₮₤ЇŊ€✭™ ]")
